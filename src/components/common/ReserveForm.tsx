  ...
  return (
    ...
    >
      ...
      <div className="pt-4 space-y-3">
        <Button
          type="submit"
          className="w-full bg-red-600 hover:bg-red-700 text-white text-lg py-6 rounded-full transition-all shadow-md"
        >
          予約を確定する
        </Button>
